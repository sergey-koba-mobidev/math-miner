...
import type { ResourceType, EquipmentLevels } from './types';

export const TILE_ROWS = 500;
export const TILE_COLS = 12;
export const TILE_SIZE_PX = 64;

export const initialEquipment: EquipmentLevels = {
  WEAPON: 0,
  SHIELD: 0,
  HELMET: 0,
  ARMOR: 0,
...
// Drawing logic for each icon
const drawDirtIcon = (ctx: CanvasRenderingContext2D, frame: number, size: number) => {
...
const drawStoneIcon = (ctx: CanvasRenderingContext2D, frame: number, size: number) => {
...
const drawMineralIcon = (ctx: CanvasRenderingContext2D, frame: number, size: number) => {
...
const drawSilverIcon = (ctx: CanvasRenderingContext2D, frame: number, size: number) => {
...
const drawGoldIcon = (ctx: CanvasRenderingContext2D, frame: number, size: number) => {
    const grad = ctx.createRadialGradient(size*0.4, size*0.4, size*0.05, size/2, size/2, size*0.6);
...
const drawDynamiteIcon = (ctx: CanvasRenderingContext2D, frame: number, size: number) => {
...
// --- CHARACTER DRAWING ENGINE (V8 - COMPLEX MOBS) ---
...
// --- V5 EQUIPMENT DRAWING FUNCTIONS ---
