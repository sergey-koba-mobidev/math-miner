...
const urlsToCache = [
  ...
  './services/translations/en.ts',
  './services/translations/ua.ts',
  './services/translations/pl.ts',
  './services/translations/es.ts',
  './services/translations/de.ts',
  './services/translations/schema.ts',
  ...
  './components/Tile.tsx',
  './components/icons/CanvasIcon.tsx',
  './components/icons/GameIcons.tsx',
  './services/drawing/characterDrawers.ts',
  './services/drawing/iconDrawers.ts',
  './services/drawing/tileDrawers.ts',
  './data/equipment.ts',
  './data/mobs.ts',
  './data/mobSprites.ts',
