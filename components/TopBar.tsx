...
import { RESOURCE_ICONS, DepthIcon, ShopIcon, BestiaryIcon, SettingsIcon } from '../constants';
...
export const TopBar: React.FC<TopBarProps> = ({ resources, accessibleDepth, hero, mob, floatingTexts, onShopOpen, onBestiaryOpen, onSettingsOpen, equipmentLevels, heroAnimation, mobAnimation, blinkingResources }) => {
  return (
      ...
      <div className="w-full grid grid-cols-[1fr_auto_1fr] items-start gap-4">
        ...
        <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex justify-around items-center w-full max-w-lg">
                ...
                />
                <span className="text-2xl font-bold text-stone-400 animate-pulse">VS</span>
            ...
            <div className="flex justify-center items-center flex-wrap gap-2 md:gap-4 bg-stone-900/70 p-2 rounded-lg w-full max-w-2xl">
                ...
                <div className="flex items-center gap-2 bg-stone-900/50 p-2 rounded-lg" title="Current accessible depth">
                    <DepthIcon />
        ...
        <div className="justify-self-end flex items-center gap-2">
            ...
            <button onClick={onSettingsOpen} className="flex items-center gap-2 bg-stone-600/50 hover:bg-stone-500/50 p-2 rounded-lg transition-colors" title="Open Settings">
                <SettingsIcon />
            </button>
        </div>
      </div>
